    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Create Policy</h3>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('page_banner_subtitle') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('page_banner_image_alt_text') }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('meta_keywords') is-invalid @enderror"
                                    id="meta_keywords" name="meta_keywords">{{ old('meta_keywords') }}</textarea>
                                @error('meta_keywords')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
