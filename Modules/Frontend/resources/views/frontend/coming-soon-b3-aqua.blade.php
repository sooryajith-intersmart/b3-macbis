        ...
        <div class="container">
            <div class="row">
                <div class="page_cntnt">
                    ...
                    <div class="imgB1">
                        <img src="{{ asset('frontend/images/v-logo-05.png') }}" width="260px" height="45px" alt="business logo">
                    </div>
                    <h4 class="head_three">Our digital pipelines are under construction.</h4>
                    <ul>
                        <li>
