        ...
        <div class="container">
            <div class="row">
                <div class="page_cntnt">
                    <div class="imgB">
                        <img src="{{ asset('frontend/images/Background1.JPG') }}" width="600px" height="600px" alt="business logo">
                    </div>
                    <div class="imgB1">
                        <img src="{{ asset('frontend/images/v-logo-03.png') }}" width="260px" height="45px" alt="business logo">
                    </div>
                    <h4 class="head_three">Buckle up! We're revamping to make your rides better and safer!</h4>
                    <ul>
                        <li>
