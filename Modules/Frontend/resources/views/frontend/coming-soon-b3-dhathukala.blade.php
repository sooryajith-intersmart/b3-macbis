        ...
        <div class="container">
            <div class="row">
                <div class="page_cntnt">
                    <div class="imgB">
                        <img src="{{ asset('frontend/images/Background3.JPG') }}" width="600px" height="600px" alt="business logo">
                    </div>
                    <div class="imgB1">
                        <img src="{{ asset('frontend/images/v-logo-06.png') }}" width="260px" height="45px" alt="business logo">
                    </div>
                    <h4 class="head_three">Our digital foundry is currently ablaze. <br>Stay tuned for metal art wonders!</h4>
                    <ul>
                        <li>
