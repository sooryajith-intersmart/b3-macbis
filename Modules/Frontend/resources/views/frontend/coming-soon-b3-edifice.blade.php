        ...
        <div class="container">
            <div class="row">
                <div class="page_cntnt">
                    <div class="imgB">
                        <img src="{{ asset('frontend/images/Background2.JPG') }}" width="600px" height="600px" alt="business logo">
                    </div>
                    <div class="imgB1">
                        <img src="{{ asset('frontend/images/v-logo-04.png') }}" width="260px" height="45px" alt="business logo">
                    </div>
                    <h4 class="head_three">Our virtual blueprint is in progress. <br>Stay tuned for architectural excellence!</h4>
                    <ul>
                        <li>
