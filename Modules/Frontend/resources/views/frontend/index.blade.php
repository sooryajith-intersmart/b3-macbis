    ...
    <section id="MainBanner">
        <div class="sp-container rgt">
            <div class="dFlx">
                ...
                @if(!empty($first_sliders) && !empty($second_sliders) && !empty($third_sliders) && !empty($fourth_sliders))
                <div class="rgtSd">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{ $first_slider->link }}" target="_blank">
                                            <div class="imgWrap">
                                                <img src="{{ $first_slider->image_value }}" width="300" height="1000" alt="{{ $first_slider->image__alt_text }}">
                                                <div class="bttmWrap">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{ $second_slider->link }}" target="_blank">
                                            <div class="imgWrap">
                                                <img src="{{ $second_slider->image_value }}" width="300" height="1000" alt="{{ $second_slider->image__alt_text }}">
                                                <div class="bttmWrap">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{ $third_slider->link }}" target="_blank">
                                            <div class="imgWrap">
                                                <img src="{{ $third_slider->image_value }}" width="300" height="1000" alt="{{ $third_slider->image__alt_text }}">
                                                <div class="bttmWrap">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{ $fourth_slider->link }}" target="_blank">
                                            <div class="imgWrap">
                                                <img src="{{ $fourth_slider->image_value }}" width="300" height="1000" alt="{{ $fourth_slider->image__alt_text }}">
                                                <div class="bttmWrap">
                ...
                <div class="splide__track">
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide wow animate__fadeInUp" data-wow-duration="1s">
                            <div class="busiBx">
                                <div class="imgWrap">
                                    <img src="{{ $business->image_value }}" width="510" height="280" alt="{{ $business->image_alt_text }}">
                                ...
                                <div class="cntWrap">
                                    ...
                                    <div class="logoWrap">
                                        <img src="{{ $business->logo_value }}" width="260px" height="45px" alt="{{ $business->logo_alt_text }}">
                                    </div>
                                </div>
                                <a href="{{ $business->link }}" target="_blank" class="visitBtn">
                                    <span>VISIT WEBSITE</span>
                                    <span class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="13.561" height="13.741" viewBox="0 0 13.561 13.741">
                                            <g id="arrow" transform="translate(-1618.5 -845.716)">
                                                <path id="Path_166" data-name="Path 166" d="M25,0H37.84" transform="translate(1593.5 852.421)" fill="none" stroke="#fff" stroke-width="1" />
                                                <path id="Path_165" data-name="Path 165" d="M6270.4,849.083l6.773,6.246L6270.4,862.1" transform="translate(-4645.837 -3)" fill="none" stroke="#fff" stroke-width="1" />
                                            </g>
                                        </svg>
                                    </span>
                                </a>
    ...
    <section id="OurStory">
        <div class="container">
            <div class="dFlx">
                <div class="lftSd">
                    <div class="imgWrap">
                        <img src="{{ $home->section_three_image_value }}" width="723" height="720" alt="{{ $home->section_three_title }}">
                    </div>
                    <!-- <div class="galGrid">
                        <div class="galRow">
                                ...
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.883 21.598">
                                        <g id="Group_4" data-name="Group 4" transform="translate(-1054.246 1277.886) rotate(-90)">
                                            <path id="Path_9" data-name="Path 9" d="M1277.525,1090.64l-10.437,10.954-10.437-10.954" transform="translate(0 -26.191)" fill="none" stroke="#000" stroke-width="1"></path>
                                            <path id="Path_10" data-name="Path 10" d="M1293.877,1053.246V1074.4" transform="translate(-26.79 1)" fill="none" stroke="#000" stroke-width="1"></path>
                                        </g>
                                    </svg>
                                </span>
                            </a>
