        ...
        <div id="HeaderMain">
            <div class="container">
                <div class="mainFlx">
                    ...
                    <div class="RSide">
                        <div class="modal fade" id="HeaderPOP" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="HeaderPOPLabel" aria-hidden="true">
                                        ...
                                        <div class="accordion" id="AccordMenu">
                                            <div class="accordion-item">
                                                <div class="accordion-header">
                                                    <a href="{{ route('home') }}" class="accordion-button {{ Nav::isRoute('home') }}">
                                                        HOME</a>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                                                <div class="accordion-header">
                                                    <a href="{{ route('about') }}" class="accordion-button {{ Nav::isRoute('about') }}">
                                                        OUR STORY
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header">
                                                    <a href="{{ route('blogs') }}" class="accordion-button {{ Nav::isRoute(['blogs', 'blog.details']) }}">
                                                        BLOG
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header">
                                                    <a href="{{ route('contact') }}" class="accordion-button {{ Nav::isRoute('contact') }}">
                                                        CONTACT US
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <li>
                                                <div class="infoBx">
                                                    <a href="{{ $registered_address_map_link }}" class="locBtn">
                                                        <span>See Map</span>
                                                        <span class="icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="12.791" height="12.628" viewBox="0 0 12.791 12.628">
                                                                <g id="Group_4" data-name="Group 4" transform="translate(-1054.246 1268.917) rotate(-90)">
                                                                    <path id="Path_9" data-name="Path 9" d="M1268.555,1090.64l-5.952,6.247-5.952-6.247" transform="translate(0 -30.575)" fill="none" stroke="#000" stroke-width="1"></path>
                                                                    <path id="Path_10" data-name="Path 10" d="M1293.877,1053.246v12.065" transform="translate(-31.274 1)" fill="none" stroke="#000" stroke-width="1"></path>
                                                                </g>
                                                            </svg>
                                                        </span>
                                                    </a>
