...
// WATERMARK
const watermark = "InterSmart Solutions https://www.intersmartsolution.com";
console.log("Powered by " + watermark);

// HEADER
document.addEventListener("DOMContentLoaded", function () {
    // Check if the element with ID "Header" exists
    ...
    if (headerElement) {
        ...
        window.addEventListener("scroll", function () {
            ...
            if (window.scrollY > headerScrollPos) {
                ...
                // Remove the "sticky" class if not scrolled far enough
...
// HEADER OPEN
document.getElementById('HeaderPOP').addEventListener("shown.bs.modal", function () {
    document.querySelector(".menuIcon").classList.add("open");
});
document.getElementById('HeaderPOP').addEventListener("hide.bs.modal", function () {
...
document.addEventListener("DOMContentLoaded", function () {
    if ($(window).width() <= 768) {
        ...
        $("footer .accordion-button").removeClass("collapsed"),
        $("footer .accordion-button").attr("aria-expanded", "false")
    }
});
...
document.addEventListener("DOMContentLoaded", function () {
    $('#file-upload').change(function () {
        var labelElement = $(this).closest('.fileUploadInput').find("label");
        var file = this.files[0].name;
        labelElement.text(file);
    });
});
